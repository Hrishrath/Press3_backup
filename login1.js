    ...
    $.ajax({
        ...
        success: function (res, textStatus, errorThrown) {
            ...
            if (res.status == 999) {
                ...
                else if (res.RoleId == 5) { window.location.href = "/DisplayDachboard.aspx"; }
                ...
                if (res.Success == "True") {
                    if (res.AgentDetails.length > 0) {
                        ...
                        else if (res.AgentDetails[0].RoleId == 5) {
                            window.location.href = "/DisplayDashboard.aspx";
                        }
                            // No role assigned
                        else {
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            ...
            if (jqXHR.status == 999) {
                ...
                else if (jqXHR.RoleId == 5) { window.location.href = "/DisplayDashboard.aspx"; }
                else { window.location.href = "/Login.aspx?message=Session expired"; }
            } else {
                console.log(errorThrown);
                $("#divActiveCalls").html("");
